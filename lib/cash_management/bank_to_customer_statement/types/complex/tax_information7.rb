...
# lib/cash_management/bank_to_customer_statement/types/complex/tax_information7.rb

module CashManagement
  module BankToCustomerStatement
    # Represents the TaxInformation7 element in a camt.053.001.08 message
    # @see https://www.iso20022.org/standardsrepository/type/TaxInformation7
    class TaxInformation7
      attr_reader :creditor, :debtor, :ultimate_debtor, :administration_zone,
                  :reference_number, :method, :total_taxable_base_amount,
                  :total_tax_amount, :date, :sequence_number, :records, :raw

      # Initialize a new TaxInformation7 instance from an XML element
      ...
      def initialize(element)
        ...
        @ultimate_debtor = element.at_xpath("./UltmtDbtr") ? TaxParty2.new(element.at_xpath("./UltmtDbtr")) : nil
