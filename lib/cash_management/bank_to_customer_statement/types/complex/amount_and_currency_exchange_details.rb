...
# lib/cash_management/bank_to_customer_statement/types/amount_and_currency_exchange_details.rb

module CashManagement
  module BankToCustomerStatement
    # Represents the AmountAndCurrencyExchangeDetails3 element in a camt.053.001.08 message
    # @see https://www.iso20022.org/standardsrepository/type/AmountAndCurrencyExchangeDetails3
    class AmountAndCurrencyExchangeDetails
      attr_reader :amount, :currency_exchange, :raw
