...
module CashManagement
  module BankToCustomerStatement
    # Represents the GenericPersonIdentification1 element in a camt.053.001.08 message
    # @see https://www.iso20022.org/standardsrepository/type/GenericPersonIdentification1
    class GenericPersonIdentification
      attr_reader :id, :scheme_name, :issuer, :raw

      # Initialize a new GenericPersonIdentification instance from an XML element
